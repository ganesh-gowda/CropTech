...
function ResultCard({ result, onBack }) {
  return (
    <div className="bg-gradient-to-r from-green-500 to-green-700 rounded-lg px-4 m-8 h-[calc(100vh-80px)] relative p-2" style={{marginTop:"100px"}}>
      <div className="bg-lime-100 flex flex-row p-12 m-6 h-[calc(100vh-150px)] rounded-xl">
